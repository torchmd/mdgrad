...
'lj_0.7_0.2': {
    ...
    'overalp_0.9766_T0.07_cut12':
     ...
     "morse_a4.5_phi1.52_rho0.3_T1.0": {
        "tag": "morse_a4.5_phi1.52_rho0.3_T1.0",
        "dt": 0.005,
        "rho": 0.3,
        "T": 1.0,
        "start": 0.5,
        ...
        "N_unitcell": 4,
        "cell": FaceCenteredCubic,
        "target_pot": ModifiedMorse(a=4.5, phi=1.52)
    },
    "morse_a4.5_phi1.52_rho0.5_T1.0": {
        "tag": "morse_a4.5_phi1.52_rho0.5_T1.0",
        "dt": 0.005,
        "rho": 0.5,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a4.5_phi1.52_rho0.7_T1.0": {
        "tag": "morse_a4.5_phi1.52_rho0.7_T1.0",
        "dt": 0.005,
        "rho": 0.7,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a4.5_phi1.52_rho0.9_T1.0": {
        "tag": "morse_a4.5_phi1.52_rho0.9_T1.0",
        "dt": 0.005,
        "rho": 0.9,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a5.5_phi0.44_rho0.3_T1.0": {
        "tag": "morse_a5.5_phi0.44_rho0.3_T1.0",
        "dt": 0.005,
        "rho": 0.3,
        "T": 1.0,
        "start": 0.5,
        ...
        "N_unitcell": 4,
        "cell": FaceCenteredCubic,
        "target_pot": ModifiedMorse(a=5.5, phi=0.44)
    },
    "morse_a5.5_phi0.44_rho0.5_T1.0": {
        "tag": "morse_a5.5_phi0.44_rho0.5_T1.0",
        "dt": 0.005,
        "rho": 0.5,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a5.5_phi0.44_rho0.7_T1.0": {
        "tag": "morse_a5.5_phi0.44_rho0.7_T1.0",
        "dt": 0.005,
        "rho": 0.7,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a5.5_phi0.44_rho0.9_T1.0": {
        "tag": "morse_a5.5_phi0.44_rho0.9_T1.0",
        "dt": 0.005,
        "rho": 0.9,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a6.5_phi-0.45_rho0.3_T1.0": {
        "tag": "morse_a6.5_phi-0.45_rho0.3_T1.0",
        "dt": 0.005,
        "rho": 0.3,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a6.5_phi-0.45_rho0.5_T1.0": {
        "tag": "morse_a6.5_phi-0.45_rho0.5_T1.0",
        "dt": 0.005,
        "rho": 0.5,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a6.5_phi-0.45_rho0.7_T1.0": {
        "tag": "morse_a6.5_phi-0.45_rho0.7_T1.0",
        "dt": 0.005,
        "rho": 0.7,
        "T": 1.0,
        "start": 0.5,
    ...
    "morse_a6.5_phi-0.45_rho0.9_T1.0": {
        "tag": "morse_a6.5_phi-0.45_rho0.9_T1.0",
        "dt": 0.005,
        "rho": 0.9,
        "T": 1.0,
        "start": 0.5,
...
exp_rdf_data_dict = {
    ...
    'H20_288K_spce': { 'fn': "../data/water_sim/H2O_288K_spce.csv",
                   'rho': 1.0,
                    'T': 288.0, 
                    'start': 1.8, 
                    'end': 7.5,
    ...
    'H20_338K_spce': { 'fn': "../data/water_sim/H2O_338K_spce.csv",
                   'rho': 1.0,
                    'T': 338.0, 
                    'start': 1.8, 
                    'end': 7.5,
    ...
    'H20_388K_spce': { 'fn': "../data/water_sim/H2O_388K_spce.csv",
                   'rho': 1.0,
                    'T': 388.0, 
                    'start': 1.8, 
                    'end': 7.5,
