...
if params['id'] == None:
    experiment = conn.experiments().create(
        ...
        parameters=[
            ...
            dict(name='angle_train_start', type='int', bounds=dict(min=0, max=100)),
            dict(name='angle_MSE_weight', type='double', bounds=dict(min=1.0, max=20000.0)),
            dict(name='angle_JS_weight', type='double', bounds=dict(min=1.0, max=20000.0)),
